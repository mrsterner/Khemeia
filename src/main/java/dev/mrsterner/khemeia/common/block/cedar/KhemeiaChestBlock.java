...
public class KhemeiaChestBlock extends ChestBlock {
    protected final boolean trapped;

    public KhemeiaChestBlock(Settings settings, Supplier<BlockEntityType<? extends ChestBlockEntity>> supplier, boolean trapped) {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new KhemeiaChestBlockEntity(KhemeiaEntityTypes.KHEMEIA_CHEST, pos, state, getType(this), trapped);
    }
    ...
    public static KhemeiaChestBlockEntity.Type getType(Block block) {
        return KhemeiaChestBlockEntity.Type.CEDAR;
    }
}
