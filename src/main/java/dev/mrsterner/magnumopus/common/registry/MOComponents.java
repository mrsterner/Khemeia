...
public class MOComponents implements EntityComponentInitializer, WorldComponentInitializer {
    public static final ComponentKey<BodyComponent> BODY_COMPONENT = ComponentRegistryV3.INSTANCE.getOrCreate(new Identifier(MagnumOpus.MODID, "body"), BodyComponent.class);
